...
public class FollowTankAlllyMap3 : MonoBehaviour
{
    // khoi dong xe tang
    ...
    void Start()
    {
        GameObject playerObj = GameObject.FindGameObjectWithTag("Tank_AI");
    ...
    void Shoot()
    {
        if (bulletPrefab != null && firePoint != null)
        {
            ...
            if (rb != null)
            {
                ...
                Quaternion rot = Quaternion.LookRotation(Vector3.forward, targetDir);
                Instantiate(shootEffect, firePoint.position, rot);
            }
